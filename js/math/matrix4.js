...
export default class Matrix4
{
    ...
    rotate(degrees, axis)
    {
        ...
        return new Matrix4([ p[0] * m[0] + p[4] * m[1] + p[8] * m[3], p[1] * m[0] + p[5] * m[1] + p[9] * m[3], p[2] * m[0] + p[6] * m[1] + p[10] * m[3], p[3] * m[0] + p[7] * m[1] + p[11] * m[3], p[0] * m[4] + p[4] * m[5] + p[8] * m[6], p[1] * m[4] + p[5] * m[5] + p[9] * m[6], p[2] * m[4] + p[6] * m[5] + p[10] * m[6], p[3] * m[4] + p[7] * m[5] + p[11] * m[6], p[0] * m[8] + p[4] * m[9] + p[8] * m[10], p[1] * m[8] + p[5] * m[9] + p[9] * m[10], p[2] * m[8] + p[6] * m[9] + p[10] * m[10], p[3] * m[8] + p[7] * m[9] + p[11] * m[10], p[12], p[13], p[14], p[15] ]);
    }
