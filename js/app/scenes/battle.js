...
const enemies = [ [ 5, 10, 10, 129, 175, 'giga', 'beelzemon_blast_mode', 225, 10 ], [ 0, 0, 6, 123, 156, 'giga', 'imperaildramon_paladin_ mode', 200, 30 ], [ 10, 11, 6, 165, 161, 'giga', 'miragegaogamon_burst_mode', 175, -100 ], [ 35, 10, 20, 134, 180, 'giga', 'shinegreymon_burst_mode', 225, -50 ], [ 0, 4, 12, 78, 110, 'giga', 'rosemon_burst_mode', 175, -30 ] ];
...
export default class Battle extends Rasher.Scene
{
    setup(game)
    {
        ...
        this.hud = new HUD(this.renderer, 'foreground', [
            ...
            // 1 - top
            [ [ new Calculus.Vector4(400, 0, 1, 100), true ], [ new Calculus.Vector4(401, 0, 100, 100), false ], [ new Calculus.Vector4(702, 0, 1, 100), true ] ],
    ...
    static get config()
    {
        return {
            resources: {
                ...
                music: 'audio/digimon/dawn/battle_02.mp3', ...enemies.reduce((t, e) =>
                {
